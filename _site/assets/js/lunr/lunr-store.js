var store = [{
        ...
        "excerpt":"How We Construct the Battery Database The generation fo the batteries database takes the following steps: Create the materials database First, the tasks database is parsed by the MaterialBuilder from emmet to generate the materials database.The the builder groups calculation of similar materials together and picks the most reliable results...","categories": [],
        "tags": [],
